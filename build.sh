...
echo "If the build process has succeeded, files named 0x7a2c0.bin, 0x7a2dc.bin, 0x7a312.bin, 0x76690.bin and 0x80080000.bin will now be present in the bin directory"
