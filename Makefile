...
$(RELEASE_DISK_IMAGE): $(GAMEFILES_DESTINATION_DIR)CARS.REL $(GAMEFILES_DESTINATION_DIR)0x80000.LZ4 $(GAMEFILES_DESTINATION_DIR)SAMPLES.LZ4 $(GAMEFILES_DESTINATION_DIR)AUTO/LOADER.PRG
	rm $(RELEASE_DISK_IMAGE) || true
