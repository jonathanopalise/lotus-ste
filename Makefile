...
GENERIC_CARS_REL_PATCHES = $(BIN_DIR)0x70660.bin $(BIN_DIR)0x7086e.bin $(BIN_DIR)0x70880.bin $(BIN_DIR)0x70896.bin $(BIN_DIR)0x709c0.bin $(BIN_DIR)0x71d62.bin $(BIN_DIR)0x72afa.bin $(BIN_DIR)0x72b04.bin $(BIN_DIR)0x7450c.bin $(BIN_DIR)0x744ba.bin $(BIN_DIR)0x74586.bin $(BIN_DIR)0x7c916.bin $(BIN_DIR)0x7a2c0.bin $(BIN_DIR)0x7a2dc.bin $(BIN_DIR)0x7a312.bin $(BIN_DIR)0x7a496.bin $(BIN_DIR)0x7de36.bin $(BIN_DIR)0x7de50.bin $(BIN_DIR)0x7de6a.bin
