...
BIN_FILES= bin/0x7067e.bin bin/0x74586.bin bin/0x7666c.bin bin/0x7a2c0.bin bin/0x7a2dc.bin bin/0x7a312.bin bin/0x7a496.bin bin/0x80000.bin
...
bin/0x7067e.bin: src/0x7067e.s src/symbols.inc
	$(VASM) src/0x7067e.s -Fbin -o bin/0x7067e.bin
